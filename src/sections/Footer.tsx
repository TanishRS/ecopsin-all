...
export default function Footer() {
  ...
  return (
    <footer id="footer" className="relative z-10 text-whisper">
      ...
      <div className="mx-auto max-w-page px-6 py-20 md:px-10 md:py-28 xl:px-16">
        ...
        <div className="mt-8 flex flex-col justify-between gap-12 border-b border-whisper/15 pb-16 lg:flex-row lg:items-end">
          <h2 className="max-w-3xl font-display uppercase leading-[0.95] [font-size:clamp(2.75rem,6vw,5.5rem)]">
            Cleaner clothes,
            <br />
          ...
          <div className="max-w-sm">
            <p className="text-sm leading-relaxed text-whisper/70">
              Eurospin is a DLI-USA certified laundry &amp; dry-cleaning studio operating out of
              Thane-West with stores across the Mumbai region.
            </p>
            <div className="mt-6 flex gap-3">
              <a
                href="https://www.instagram.com/eurospin_drycleaners/"
                target="_blank"
                rel="noreferrer"
                aria-label="Eurospin on Instagram"
              ...
              <a
                href="https://www.facebook.com/eurospindrycleaners/"
                target="_blank"
                rel="noreferrer"
                aria-label="Eurospin on Facebook"
                className="inline-flex h-11 w-11 items-center justify-center border border-whisper/30 text-whisper transition-colors duration-200 hover:border-glow hover:text-glow"
              >
        ...
        <div className="grid grid-cols-1 gap-12 py-16 sm:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-6 space-y-3 text-sm text-whisper/80">
              <li>
                <a href="tel:+919004337979" className="hover:text-glow">+91 9004337979</a>
                <span className="mx-2 text-whisper/30">·</span>
                <a href="tel:+918452808888" className="hover:text-glow">+91 8452808888</a>
              </li>
              <li>
                <a href="mailto:info@eurospin.in" className="hover:text-glow">info@eurospin.in</a>
              </li>
        ...
        <div className="flex flex-col justify-between gap-3 border-t border-whisper/15 pt-8 font-mono text-[10px] uppercase tracking-label text-whisper/50 sm:flex-row">
          <p>© 2026 EUROSPIN INDIA. ALL RIGHTS RESERVED.</p>
