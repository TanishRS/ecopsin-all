...
export default function WhatsAppFloat() {
  return (
    <a
      href="https://wa.me/918657422155"
      target="_blank"
      rel="noreferrer"
      aria-label="Chat with Ecospin on WhatsApp"
      className="fixed bottom-6 right-6 z-50 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform duration-200 hover:scale-110 hover:shadow-xl"
    >
